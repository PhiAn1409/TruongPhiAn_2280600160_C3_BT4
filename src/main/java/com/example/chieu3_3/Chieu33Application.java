...
public class Chieu33Application {
	...
	public CommandLineRunner init(CategoryService categoryService) {
		return args -> {
			...
			categoryService.add(new Category(0, "Electronics"));
			categoryService.add(new Category(0, "Books"));
			categoryService.add(new Category(0, "Clothing"));
			categoryService.add(new Category(0, "Food"));
		};
	}
